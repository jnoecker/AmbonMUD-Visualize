...
export function fillSpriteTemplate(
  ...
  const genderDesc = dimensions.gender === "enby"
    ? "mysterious, fully hooded and masked, face completely hidden behind an ornate veil, body entirely concealed beneath layered flowing robes, no visible skin or body shape, gender-ambiguous enigmatic"
    : dimensions.gender;
