...
import { BlankProjectDialog } from "./components/dialogs/BlankProjectDialog";
...
function AppInner() {
  ...
  return (
    <>
        ...
        detail={
          project ? (
            ...
            <WelcomeScreen
              ...
              onNewBlankProject={() => setShowBlankProject(true)}
      ...
      {showBlankProject && <BlankProjectDialog onClose={() => setShowBlankProject(false)} />}
    </>
  );
}
